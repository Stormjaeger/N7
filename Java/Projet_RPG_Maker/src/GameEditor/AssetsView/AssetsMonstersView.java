...
public class AssetsMonstersView implements ActionListener, ValidateListener, AssetsView {
    private String pathToProject;
    private JPanel panelCharacter;
    private DatabaseAdapter characterBase;
    private ValidateListener listener; 

    public AssetsMonstersView(String path) {
        super();
