...
public class AddAttributeToCharacter extends JFrame implements ActionListener {
    ...
    public AddAttributeToCharacter(String path, Integer idCharacter, ValidateListener listener){
         
        super("Attribut à ajouter");
        ...
        JLabel label = new JLabel("Sélectionner l'attribut à ajouter");
        ...
        this.add(panel);
        //panel.add(Box.createRigidArea(new Dimension(0, 2))); // Ajouter un espace vertical entre le label et le JComboBox
        addRow("Attribut", comboBox);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        System.out.println("Liste des attribus avant : " + base.getCharacter(this.idCharacter)); 

        String listeAttributs = (base.getCharacter(this.idCharacter)).getIdAttributs();
        listeAttributs = listeAttributs + ", " + this.idAttribut; 
        base.updateCharacterAttribut(this.idCharacter, listeAttributs);
        
        //TEST 
        System.out.println("Liste des attribus après : " + base.getCharacter(this.idCharacter));
        listener.action();
