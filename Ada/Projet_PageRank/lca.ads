...
private
	...
	-- T_LCA est un pointeur vers une variable de type T_Cellule
	type T_LCA is access T_Cellule;
   
	--T_Cellule est un type enregistrement qui contient la clé et la valeur d'un élément
	--ainsi que le pointeur vers la case suivante
