...
package body Texte_A_Graphe_Pleines is

    procedure Creer_S(M_S : in out T_Matrice_P; File : in out Ada.Text_IO.File_Type) is
    ...
    procedure Creer_G(M_G : in out T_Matrice_P; Alpha : in Float;  File : in out Ada.Text_IO.File_Type) is

        Taille : Integer := Obtenir_Longueur(M_G);

        M_E : T_Matrice_P(1..Taille,1..Taille);
        M_S : T_Matrice_P(1..Taille,1..Taille);
        M_1 : T_Matrice_P(1..Taille,1..Taille);
        M_2 : T_Matrice_P(1..Taille,1..Taille);
